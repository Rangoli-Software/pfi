! function (e, t) {
	...
	e.exports = function e(t, r, n) {
		...
		for (const s in t)
			if (t.hasOwnProperty(s)) {
				const o = r(s);
				"object" == typeof t[s] && null !== t[s] && (n.includes(s) || n.includes(o) || (t[s] = e(t[s], r, n))), o !== s && (t[o] = t[s], delete t[s])
			} return t
	}
}, function (e, t, r) {
	"use strict";
	...
	class s {
		...
		static create(e) {
			return Array.isArray(e) ? e.filter(e => !!e).map(e => this.create(e)) : e instanceof s ? e : new s(e)
		}
	}
	e.exports = s
}, function (e, t, r) {
	...
	e.exports = class {
		constructor() {
			this.setClient(new n), this.setSubstitutionWrappers("{{", "}}"), this.secretRules = []
		}
		setClient(e) {
			this.client = e
		}
		...
		setSubstitutionWrappers(e, t) {
			if (void 0 === e || void 0 === t) throw new Error("Must provide both left and right side wrappers");
			Array.isArray(this.substitutionWrappers) || (this.substitutionWrappers = []), this.substitutionWrappers[0] = e, this.substitutionWrappers[1] = t
		}
		setSecretRules(e) {
		...
		filterSecrets(e) {
			...
			e.content.forEach((function (e) {
				t.secretRules.forEach((function (t) {
					if (t.hasOwnProperty("pattern") && !t.pattern.test(e.value)) return;
					let r = `The pattern '${t.pattern}'`;
					throw t.name && (r += `identified by '${t.name}'`), r += " was found in the Mail content!", new Error(r)
				}))
			}))
		}
		send(e, t = !1, r) {
			if ("function" == typeof t && (r = t, t = !1), Array.isArray(e)) {
				const n = Promise.all(e.map(e => this.send(e, t)));
				return r && n.then(e => r(null, e)).catch(e => r(e, null)), n
			}
			try {
				void 0 === e.isMultiple && (e.isMultiple = t), void 0 === e.substitutionWrappers && (e.substitutionWrappers = this.substitutionWrappers);
	...
	e.exports = class {
		constructor() {
			this.auth = "", this.impersonateSubuser = "", this.defaultHeaders = {
		...
		setApiKey(e) {
			this.auth = "Bearer " + e, this.setDefaultRequest("baseUrl", "https://api.sendgrid.com/"), this.isValidApiKey(e) || console.warn('API key does not start with "SG.".')
		}
		setTwilioEmailAuth(e, t) {
			const r = Buffer.from(e + ":" + t).toString("base64");
			this.auth = "Basic " + r, this.setDefaultRequest("baseUrl", "https://email.twilio.com/"), this.isValidTwilioAuth(e, t) || console.warn("Twilio Email credentials must be non-empty strings.")
		}
		isValidApiKey(e) {
		...
		createHeaders(e) {
			...
			return void 0 === t.Authorization && this.auth && (t.Authorization = this.auth), this.impersonateSubuser && (t["On-Behalf-Of"] = this.impersonateSubuser), t
		}
		createRequest(e) {
			let t = {
				url: e.uri || e.url,
			...
			return t = o(this.defaultRequest, t), t.headers = this.createHeaders(t.headers), t.baseURL = t.baseUrl, delete t.baseUrl, t
		}
		request(e, t) {
			e = this.createRequest(e);
			const r = new Promise((t, r) => {
				n(e).then(e => t([new i(e.status, e.data, e.headers), e.data])).catch(e => e.response && e.response.status >= 400 ? r(new a(e.response)) : r(e))
			});
	...
	var a, c = {
		adapter: ("undefined" != typeof XMLHttpRequest ? a = r(42) : "undefined" != typeof process && "[object process]" === Object.prototype.toString.call(process) && (a = r(48)), a),
		transformRequest: [function (e, t) {
			return s(t, "Accept"), s(t, "Content-Type"), n.isFormData(e) || n.isArrayBuffer(e) || n.isBuffer(e) || n.isStream(e) || n.isFile(e) || n.isBlob(e) ? e : n.isArrayBufferView(e) ? e.buffer : n.isURLSearchParams(e) ? (i(t, "application/x-www-form-urlencoded;charset=utf-8"), e.toString()) : n.isObject(e) ? (i(t, "application/json;charset=utf-8"), JSON.stringify(e)) : e
		}],
	...
	e.exports = function (e, t, r) {
		...
		!s || s(r.status) ? e(r) : t(n("Request failed with status code " + r.status, r.config, null, r.request, r))
	}
}, function (e, t, r) {
	"use strict";
	...
	function p(e) {
		...
		return Object.keys(e).forEach((function (s) {
			...
			u.request = function (e, s) {
				...
				}, e), e.nativeProtocols = r, i.equal(e.protocol, o, "protocol mismatch"), c("options", e), new f(e, s)
			}, u.get = function (e, t) {
				var r = u.request(e, t);
				return r.end(), r
			}
	...
	})), f.prototype = Object.create(a.prototype), f.prototype.write = function (e, t, r) {
		...
		if (t) {
			...
			for (var o in this._currentUrl = n.format(this._options), s._redirectable = this, l) o && s.on(o, l[o]);
			if (this._isRedirect) {
				var i = 0,
		...
		if (t && !1 !== this._options.followRedirects && e.statusCode >= 300 && e.statusCode < 400) {
			...
			var r, s = this._options.headers;
			if (307 !== e.statusCode && !(this._options.method in u))
				for (r in this._options.method = "GET", this._requestBodyBuffers = [], s) /^content-/i.test(r) && delete s[r];
			if (!this._isRedirect)
				for (r in s) /^host$/i.test(r) && delete s[r];
	...
	function n(e) {
		...
		}(e), n.destroy = s, "function" == typeof t.init && t.init(n), t.instances.push(n), n
	}
	...
	function s() {
		...
		return !1
	}, t.humanize = r(53), t.instances = [], t.names = [], t.skips = [], t.formatters = {}
}, function (e, t, r) {
	"use strict";
	const n = r(57),
		s = r(58),
	...
	s("no-color") || s("no-colors") || s("color=false") ? i = !1 : (s("color") || s("colors") || s("color=true") || s("color=always")) && (i = !0), "FORCE_COLOR" in o && (i = 0 === o.FORCE_COLOR.length || 0 !== parseInt(o.FORCE_COLOR, 10)), e.exports = {
		supportsColor: a,
	...
	e.exports = function (e, t) {
		...
		n.forEach(s, (function (e) {
			...
			n.isObject(t[s]) ? r[s] = n.deepMerge(e[s], t[s]) : void 0 !== t[s] ? r[s] = t[s] : n.isObject(e[s]) ? r[s] = n.deepMerge(e[s]) : void 0 !== e[s] && (r[s] = e[s])
	...
	e.exports = class {
		...
		fromData(e) {
			...
			e = i(e), e = s(e, ["substitutions", "dynamicTemplateData", "customArgs", "headers"]);
			const {
				to: t,
				cc: r,
				bcc: n,
			...
			this.setTo(t), this.setCc(r), this.setBcc(n), this.setSubject(o), this.setHeaders(a), this.setSubstitutions(l), this.setSubstitutionWrappers(f), this.setCustomArgs(c), this.setDynamicTemplateData(p), this.setSendAt(u)
		}
		setSubject(e) {
			if (void 0 !== e) {
		...
		setTo(e) {
			void 0 !== e && (Array.isArray(e) || (e = [e]), this.to = n.create(e))
		}
		addTo(e) {
			void 0 !== e && this.to.push(n.create(e))
		}
		setCc(e) {
			void 0 !== e && (Array.isArray(e) || (e = [e]), this.cc = n.create(e))
		}
		addCc(e) {
			void 0 !== e && this.cc.push(n.create(e))
		}
		setBcc(e) {
			void 0 !== e && (Array.isArray(e) || (e = [e]), this.bcc = n.create(e))
		}
		addBcc(e) {
		...
		toJSON() {
			...
			if (Array.isArray(t) && t.length > 0 && (p.cc = t), Array.isArray(r) && r.length > 0 && (p.bcc = r), Object.keys(s).length > 0 && (p.headers = s), u && Object.keys(u).length > 0) {
				const [e, t] = l;
				p.substitutions = c(u, e, t)
			}
			return Object.keys(i).length > 0 && (p.customArgs = i), f && Object.keys(f).length > 0 && (p.dynamicTemplateData = f), void 0 !== n && (p.subject = n), void 0 !== a && (p.sendAt = a), o(p, ["substitutions", "dynamicTemplateData", "customArgs", "headers"])
		}
	}
}, function (e, t, r) {
	"use strict";
	...
	"use strict";
	e.exports = function (e) {
		return e.map(e => "object" == typeof e && null !== e && "function" == typeof e.toJSON ? e.toJSON() : e)
	}
}, function (e, t, r) {
	var n = r(81),
		s = {};
	...
	for (var a in i)
		...
		var t, r, n = e[0] / 255,
			...
			a = Math.max(n, s, o),
			c = a - i;
		return a === i ? t = 0 : n === a ? t = (s - o) / c : s === a ? t = 2 + (o - n) / c : o === a && (t = 4 + (n - s) / c), (t = Math.min(60 * t, 360)) < 0 && (t += 360), r = (i + a) / 2, [t, 100 * (a === i ? 0 : r <= .5 ? c / (a + i) : c / (2 - a - i)), 100 * r]
	}, i.rgb.hsv = function (e) {
		var t, r, n, s, o, i = e[0] / 255,
			a = e[1] / 255,
			c = e[2] / 255,
			u = Math.max(i, a, c),
			l = u - Math.min(i, a, c),
		...
		return 0 === l ? s = o = 0 : (o = l / u, t = f(i), r = f(a), n = f(c), i === u ? s = n - r : a === u ? s = 1 / 3 + t - n : c === u && (s = 2 / 3 + r - t), s < 0 ? s += 1 : s > 1 && (s -= 1)), [360 * s, 100 * o, 100 * u]
		...
		var t, r = e[0] / 255,
			n = e[1] / 255,
			s = e[2] / 255;
		return [100 * ((1 - r - (t = Math.min(1 - r, 1 - n, 1 - s))) / (1 - t) || 0), 100 * ((1 - n - t) / (1 - t) || 0), 100 * ((1 - s - t) / (1 - t) || 0), 100 * t]
		...
		for (var c in n)
			if (n.hasOwnProperty(c)) {
				var u = n[c],
					l = (o = e, i = u, Math.pow(o[0] - i[0], 2) + Math.pow(o[1] - i[1], 2) + Math.pow(o[2] - i[2], 2));
				l < a && (a = l, r = c)
			} return r
		...
		var t = i.rgb.xyz(e),
			...
			n = t[1],
			s = t[2];
		return n /= 100, s /= 108.883, r = (r /= 95.047) > .008856 ? Math.pow(r, 1 / 3) : 7.787 * r + 16 / 116, [116 * (n = n > .008856 ? Math.pow(n, 1 / 3) : 7.787 * n + 16 / 116) - 16, 500 * (r - n), 200 * (n - (s = s > .008856 ? Math.pow(s, 1 / 3) : 7.787 * s + 16 / 116))]
	}, i.hsl.rgb = function (e) {
		var t, r, n, s, o, i = e[0] / 360,
			a = e[1] / 100,
			c = e[2] / 100;
		if (0 === a) return [o = 255 * c, o, o];
		t = 2 * c - (r = c < .5 ? c * (1 + a) : c + a - c * a), s = [0, 0, 0];
		for (var u = 0; u < 3; u++)(n = i + 1 / 3 * -(u - 1)) < 0 && n++, n > 1 && n--, o = 6 * n < 1 ? t + 6 * (r - t) * n : 2 * n < 1 ? r : 3 * n < 2 ? t + (r - t) * (2 / 3 - n) * 6 : t, s[u] = 255 * o;
		return s
		...
		var t = e[0],
			...
			s = r,
			o = Math.max(n, .01);
		return r *= (n *= 2) <= 1 ? n : 2 - n, s *= o <= 1 ? o : 2 - o, [t, 100 * (0 === n ? 2 * s / (o + s) : 2 * r / (n + r)), 100 * ((n + r) / 2)]
		...
		var t, r, n, s = e[0],
			...
			i = e[2] / 100,
			a = Math.max(i, .01);
		return n = (2 - o) * i, r = o * a, [s, 100 * (r = (r /= (t = (2 - o) * a) <= 1 ? t : 2 - t) || 0), 100 * (n /= 2)]
	}, i.hwb.rgb = function (e) {
		var t, r, n, s, o, i, a, c = e[0] / 360,
			u = e[1] / 100,
			l = e[2] / 100,
			f = u + l;
		switch (f > 1 && (u /= f, l /= f), n = 6 * c - (t = Math.floor(6 * c)), 0 != (1 & t) && (n = 1 - n), s = u + n * ((r = 1 - l) - u), t) {
			default:
			case 6:
			case 0:
				o = r, i = s, a = u;
		...
		var t = e[0] / 100,
			...
			n = e[2] / 100,
			s = e[3] / 100;
		return [255 * (1 - Math.min(1, t * (1 - s) + s)), 255 * (1 - Math.min(1, r * (1 - s) + s)), 255 * (1 - Math.min(1, n * (1 - s) + s))]
		...
		var o = Math.pow(r, 3),
			i = Math.pow(t, 3),
			a = Math.pow(n, 3);
		return r = o > .008856 ? o : (r - 16 / 116) / 7.787, t = i > .008856 ? i : (t - 16 / 116) / 7.787, n = a > .008856 ? a : (n - 16 / 116) / 7.787, [t *= 95.047, r *= 100, n *= 108.883]
	}, i.lab.lch = function (e) {
		var t, r = e[0],
			n = e[1],
			s = e[2];
		return (t = 360 * Math.atan2(s, n) / 2 / Math.PI) < 0 && (t += 360), [r, Math.sqrt(n * n + s * s), t]
		...
		var t, r = e[0] / 255,
			...
			a = o - i;
		return t = a <= 0 ? 0 : o === r ? (n - s) / a % 6 : o === n ? 2 + (s - r) / a : 4 + (r - n) / a + 4, t /= 6, [360 * (t %= 1), 100 * a, 100 * (a < 1 ? i / (1 - a) : 0)]
	}, i.hsl.hcg = function (e) {
		var t = e[1] / 100,
			r = e[2] / 100,
			n = 1,
			s = 0;
		return (n = r < .5 ? 2 * t * r : 2 * t * (1 - r)) < 1 && (s = (r - .5 * n) / (1 - n)), [e[0], 100 * n, 100 * s]
		...
		return s = (1 - r) * n, [255 * (r * o[0] + s), 255 * (r * o[1] + s), 255 * (r * o[2] + s)]
	...
	}, c.Cancel = r(23), c.CancelToken = r(61), c.isCancel = r(11), c.all = function (e) {
		return Promise.all(e)
	}, c.spread = r(62), e.exports = c, e.exports.default = c
}, function (e, t, r) {
	"use strict";
	var n = r(0),
		s = r(4),
	...
	e.exports = function (e) {
		return a(e), e.headers = e.headers || {}, e.data = s(e.data, e.headers, e.transformRequest), e.headers = n.merge(e.headers.common || {}, e.headers[e.method] || {}, e.headers), n.forEach(["delete", "get", "head", "post", "put", "patch", "common"], (function (t) {
			delete e.headers[t]
		})), (e.adapter || i.adapter)(e).then((function (t) {
			return a(e), t.data = s(t.data, t.headers, e.transformResponse), t
		}), (function (t) {
			return o(t) || (a(e), t && t.response && (t.response.data = s(t.response.data, t.response.headers, e.transformResponse))), Promise.reject(t)
		}))
	}
}, function (e, t, r) {
	"use strict";
	...
	e.exports = function (e) {
		return new Promise((function (t, l) {
			...
			if (h.open(e.method.toUpperCase(), o(m, e.params, e.paramsSerializer), !0), h.timeout = e.timeout, h.onreadystatechange = function () {
					...
					e.timeoutErrorMessage && (t = e.timeoutErrorMessage), l(u(t, e, "ECONNABORTED", h)), h = null
	...
	e.exports = function (e) {
		return new Promise((function (t, r) {
			var y = function (e) {
				...
				w = e.data,
				v = e.headers;
			if (v["User-Agent"] || v["user-agent"] || (v["User-Agent"] = "axios/" + h.version), w && !n.isStream(w)) {
				if (Buffer.isBuffer(w));
				else if (n.isArrayBuffer(w)) w = Buffer.from(new Uint8Array(w));
				else {
					if (!n.isString(w)) return b(d("Data after transformation must be a string, an ArrayBuffer, a Buffer, or a Stream", e));
					w = Buffer.from(w, "utf-8")
				}
				v["Content-Length"] = w.length
			}
			var x = void 0;
			...
			var M, T = e.proxy;
			if (!T && !1 !== T) {
				var R = A.slice(0, -1) + "_proxy",
					_ = process.env[R] || process.env[R.toUpperCase()];
				if (_) {
					var D = f.parse(_),
						B = process.env.no_proxy || process.env.NO_PROXY,
						P = !0;
					if (B) P = !B.split(",").map((function (e) {
						return e.trim()
					})).some((function (e) {
						return !!e && ("*" === e || ("." === e[0] && E.hostname.substr(E.hostname.length - e.length) === e || E.hostname === e))
					}));
					if (P && (T = {
							host: D.hostname,
							port: D.port
			...
			if (T && (k.hostname = T.host, k.host = T.host, k.headers.host = E.hostname + (E.port ? ":" + E.port : ""), k.port = T.port, k.path = A + "//" + E.hostname + (E.port ? ":" + E.port : "") + k.path, T.auth)) {
				var F = Buffer.from(T.auth.username + ":" + T.auth.password, "utf8").toString("base64");
				k.headers["Proxy-Authorization"] = "Basic " + F
			}
			var q = j && (!T || m.test(T.protocol));
			e.transport ? M = e.transport : 0 === e.maxRedirects ? M = q ? c : a : (e.maxRedirects && (k.maxRedirects = e.maxRedirects), M = q ? l : u), e.maxContentLength && e.maxContentLength > -1 && (k.maxBodyLength = e.maxContentLength);
			var I = M.request(k, (function (t) {
				if (!I.aborted) {
					var r = t;
					switch (t.headers["content-encoding"]) {
						...
						case "compress":
						case "deflate":
							r = 204 === t.statusCode ? r : r.pipe(p.createUnzip()), delete t.headers["content-encoding"]
					}
					var n = t.req || I,
						o = {
							status: t.statusCode,
					...
					if ("stream" === e.responseType) o.data = r, s(y, b, o);
						...
						r.on("data", (function (t) {
							i.push(t), e.maxContentLength > -1 && Buffer.concat(i).length > e.maxContentLength && (r.destroy(), b(d("maxContentLength size of " + e.maxContentLength + " exceeded", e, null, n)))
						})), r.on("error", (function (t) {
							I.aborted || b(g(t, e, null, n))
						})), r.on("end", (function () {
							var t = Buffer.concat(i);
							"arraybuffer" !== e.responseType && (t = t.toString(e.responseEncoding)), o.data = t, s(y, b, o)
						}))
					}
				}
			}));
			I.on("error", (function (t) {
				I.aborted || b(g(t, e, null, I))
			})), e.timeout && I.setTimeout(e.timeout, (function () {
				I.abort(), b(d("timeout of " + e.timeout + "ms exceeded", e, "ECONNABORTED", I))
			})), e.cancelToken && e.cancelToken.promise.then((function (e) {
				I.aborted || (I.abort(), b(e))
			})), n.isStream(w) ? w.on("error", (function (t) {
				b(g(t, e, null, I))
			})).pipe(I) : I.end(w)
		}))
	}
	...
	"undefined" == typeof process || "renderer" === process.type ? e.exports = r(52) : e.exports = r(54)
}, function (e, t, r) {
	function n() {
		var e;
		try {
	...
	e.exports = function (e, t) {
		...
		if ("number" === c && !1 === isNaN(e)) return t.long ? i(a = e, o, "day") || i(a, s, "hour") || i(a, n, "minute") || i(a, r, "second") || a + " ms" : function (e) {
	...
	var n = r(55),
		s = r(56);
	(t = e.exports = r(20)).init = function (e) {
		e.inspectOpts = {};
		...
		if (this.useColors) {
			var n = this.color,
				s = "[3" + (n < 8 ? n : "8;5;" + n),
				o = "  " + s + ";1m" + r + " [0m";
			e[0] = o + e[0].split("\n").join("\n" + o), e.push(s + "m+" + t.humanize(this.diff) + "[0m")
	...
	e.exports = JSON.parse('{"_from":"@sendgrid/client@^7.2.5","_id":"@sendgrid/client@7.2.5","_inBundle":false,"_integrity":"sha512-UZxk0liUeOMwbBkvlFJUezzP+w+gV6n13IAbG49KEiqwOns02HeSinFwF/CK0vQfjr3wkXRGKS34gvic53rlOg==","_location":"/@sendgrid/client","_phantomChildren":{"follow-redirects":"1.5.10"},"_requested":{"type":"range","registry":true,"raw":"@sendgrid/client@^7.2.5","name":"@sendgrid/client","escapedName":"@sendgrid%2fclient","scope":"@sendgrid","rawSpec":"^7.2.5","saveSpec":null,"fetchSpec":"^7.2.5"},"_requiredBy":["/@sendgrid/mail"],"_resolved":"https://registry.npmjs.org/@sendgrid/client/-/client-7.2.5.tgz","_shasum":"912575a5ecfe91c250eb6b267711dff2dea4e0f1","_spec":"@sendgrid/client@^7.2.5","_where":"/Users/Shared/pfi/node_modules/@sendgrid/mail","author":{"name":"Twilio SendGrid","email":"help@twilio.com","url":"sendgrid.com"},"bugs":{"url":"https://github.com/sendgrid/sendgrid-nodejs/issues"},"bundleDependencies":false,"contributors":[{"name":"Kyle Partridge","email":"kyle.partridge@sendgrid.com"},{"name":"David Tomberlin","email":"david.tomberlin@sendgrid.com"},{"name":"Swift","email":"swift@sendgrid.com"},{"name":"Brandon West","email":"brandon.west@sendgrid.com"},{"name":"Scott Motte","email":"scott.motte@sendgrid.com"},{"name":"Robert Acosta","email":"robert.acosta@sendgrid.com"},{"name":"Elmer Thomas","email":"ethomas@twilio.com"},{"name":"Adam Reis","email":"adam@reis.nz"}],"dependencies":{"@sendgrid/helpers":"^7.2.4","axios":"^0.19.2"},"deprecated":false,"description":"Twilio SendGrid NodeJS API client","devDependencies":{"nock":"^10.0.6"},"engines":{"node":"6.* || 8.* || >=10.*"},"gitHead":"63c18ce5492ed1c59d293be24de9fee9dadd1a9f","homepage":"https://sendgrid.com","license":"MIT","main":"index.js","name":"@sendgrid/client","publishConfig":{"access":"public"},"repository":{"type":"git","url":"git://github.com/sendgrid/sendgrid-nodejs.git"},"tags":["http","rest","api","mail","sendgrid"],"version":"7.2.5"}')
}, function (e, t, r) {
	"use strict";
	const n = r(65),
		s = r(7),
	...
	e.exports = class {
		...
		fromData(e) {
			...
			if (void 0 !== t && void 0 !== c) throw new Error("The props 'content' and 'filePath' cannot be used together.");
			this.setFilename(r), this.setType(s), this.setDisposition(i), this.setContentId(a), this.setContent(c ? this.readFile(c) : t)
		}
		readFile(e) {
		...
		setContent(e) {
			if ("string" != typeof e) {
				if (e instanceof Buffer && void 0 !== e.toString) return this.content = e.toString(), void("attachment" === this.disposition && (this.content = e.toString("base64")));
				throw new Error("`content` expected to be either Buffer or string")
			}
			this.content = e
		}
		setFileContent(e) {
			if (!(e instanceof Buffer && void 0 !== e.toString)) throw new Error("`content` expected to be Buffer");
		...
		toJSON() {
			...
			return void 0 !== r && (i.type = r), void 0 !== n && (i.disposition = n), void 0 !== o && (i.contentId = o), s(i)
		}
	}
}, function (e, t, r) {
	"use strict";
	...
	const n = r(7),
		...
		c = r(28),
		{
			DYNAMIC_TEMPLATE_CHAR_WARNING: u
		} = r(72),
		{
			validateMailSettings: l,
			validateTrackingSettings: f
		} = r(73);
	class p {
		constructor(e) {
		...
		fromData(e) {
			...
			const {
				...
				trackingSettings: S,
				substitutions: j,
				substitutionWrappers: O,
				dynamicTemplateData: k,
				isMultiple: M,
				hideWarnings: T
			} = e;
			this.setFrom(r), this.setReplyTo(n), this.setSubject(u), this.setSendAt(c), this.setTemplateId(h), this.setBatchId(y), this.setIpPoolName(m), this.setAttachments(g), this.setContent(p), this.setSections(b), this.setHeaders(w), this.setCategories(x), this.setCategories(v), this.setCustomArgs(C), this.setAsm(E), this.setMailSettings(A), this.setTrackingSettings(S), this.setHideWarnings(T), this.isDynamic ? this.setDynamicTemplateData(k) : (this.setSubstitutions(j), this.setSubstitutionWrappers(O)), this.addTextContent(l), this.addHtmlContent(f), d ? this.setPersonalizations(d) : M && Array.isArray(t) ? t.forEach(e => this.addTo(e, s, i)) : this.addTo(t, s, i)
		}
		setFrom(e) {
			if (void 0 !== e) {
				if ("string" != typeof e && "string" != typeof e.email) throw new Error("String or address object expected for `from`");
				this.from = n.create(e)
			}
		}
		setReplyTo(e) {
			if (void 0 !== e) {
				if ("string" != typeof e && "string" != typeof e.email) throw new Error("String or address object expected for `replyTo`");
				this.replyTo = n.create(e)
			}
		}
		setSubject(e) {
			if (void 0 !== e) {
		...
		setTemplateId(e) {
			if (void 0 !== e) {
				if ("string" != typeof e) throw new Error("String expected for `templateId`");
				0 === e.indexOf("d-") && (this.isDynamic = !0), this.templateId = e
			}
		}
		setBatchId(e) {
			if (void 0 !== e) {
				if ("string" != typeof e) throw new Error("String expected for `batchId`");
				this.batchId = e
			}
		}
		setIpPoolName(e) {
			if (void 0 !== e) {
				if ("string" != typeof e) throw new Error("String expected for `ipPoolName`");
				this.ipPoolName = e
			}
		}
		setAsm(e) {
			if (void 0 !== e) {
				if ("object" != typeof e) throw new Error("Object expected for `asm`");
				if ("number" != typeof e.groupId) throw new Error("Expected `asm` to include an integer in its `groupId` field");
				if (e.groupsToDisplay && (!Array.isArray(e.groupsToDisplay) || !e.groupsToDisplay.every(e => "number" == typeof e))) throw new Error("Array of integers expected for `asm.groupsToDisplay`");
				this.asm = e
			}
		}
		setPersonalizations(e) {
			if (void 0 !== e) {
				if (!Array.isArray(e) || !e.every(e => "object" == typeof e)) throw new Error("Array of objects expected for `personalizations`");
				this.personalizations = [], e.forEach(e => this.addPersonalization(e))
			}
		}
		addPersonalization(e) {
			this.isDynamic && e.substitutions ? delete e.substitutions : !this.isDynamic && e.dynamicTemplateData && delete e.dynamicTemplateData, e instanceof s || (e = new s(e)), this.isDynamic ? this.applyDynamicTemplateData(e) : this.applySubstitutions(e), this.personalizations.push(e)
		}
		addTo(e, t, r) {
			if (void 0 === e && void 0 === t && void 0 === r) throw new Error("Provide at least one of to, cc or bcc");
			this.addPersonalization(new s({
				to: e,
				cc: t,
				bcc: r
			}))
		...
		applySubstitutions(e) {
			e instanceof s && (e.reverseMergeSubstitutions(this.substitutions), e.setSubstitutionWrappers(this.substitutionWrappers))
		}
		applyDynamicTemplateData(e) {
			e instanceof s && e.deepMergeDynamicTemplateData(this.dynamicTemplateData)
		}
		setDynamicTemplateData(e) {
			if (void 0 !== e) {
				if ("object" != typeof e) throw new Error("Object expected for `dynamicTemplateData`");
				this.hideWarnings || Object.values(e).forEach(e => {
		...
		setContent(e) {
			if (void 0 !== e) {
				if (!Array.isArray(e)) throw new Error("Array expected for `content`");
				if (!e.every(e => "object" == typeof e)) throw new Error("Expected each entry in `content` to be an object");
				if (!e.every(e => "string" == typeof e.type)) throw new Error("Expected each `content` entry to contain a `type` string");
				if (!e.every(e => "string" == typeof e.value)) throw new Error("Expected each `content` entry to contain a `value` string");
				this.content = e
			}
		}
		addContent(e) {
			if ("object" != typeof e) throw new Error("Object expected for `content`");
			this.content.push(e)
		}
		addTextContent(e) {
			if (void 0 !== e) {
				if ("string" != typeof e) throw new Error("String expected for `text`");
				this.addContent({
					value: e,
					type: "text/plain"
				})
		...
		addHtmlContent(e) {
			if (void 0 !== e) {
				if ("string" != typeof e) throw new Error("String expected for `html`");
				this.addContent({
					value: e,
					type: "text/html"
				})
		...
		setAttachments(e) {
			if (void 0 !== e) {
				if (!Array.isArray(e)) throw new Error("Array expected for `attachments`");
				if (!e.every(e => "string" == typeof e.content)) throw new Error("Expected each attachment to contain a `content` string");
				if (!e.every(e => "string" == typeof e.filename)) throw new Error("Expected each attachment to contain a `filename` string");
				if (!e.every(e => e.type && "string" == typeof e.type)) throw new Error("Expected the attachment's `type` field to be a string");
				if (!e.every(e => e.disposition && "string" == typeof e.disposition)) throw new Error("Expected the attachment's `disposition` field to be a string");
				this.attachments = e
			}
		}
		addAttachment(e) {
			if ("object" != typeof e) throw new Error("Object expected for `attachment`");
			this.attachments.push(e)
		}
		setCategories(e) {
			if (void 0 !== e) {
				if ("string" == typeof e && (e = [e]), !Array.isArray(e) || !e.every(e => "string" == typeof e)) throw new Error("Array of strings expected for `categories`");
				this.categories = e
			}
		}
		addCategory(e) {
			if ("string" != typeof e) throw new Error("String expected for `category`");
			this.categories.push(e)
		}
		setHeaders(e) {
			if (void 0 !== e) {
				if ("object" != typeof e) throw new Error("Object expected for `headers`");
				this.headers = e
			}
		}
		addHeader(e, t) {
		...
		setSections(e) {
			if (void 0 !== e) {
				if ("object" != typeof e) throw new Error("Object expected for `sections`");
				this.sections = e
			}
		}
		setCustomArgs(e) {
			if (void 0 !== e) {
				if ("object" != typeof e) throw new Error("Object expected for `customArgs`");
				this.customArgs = e
			}
		}
		setTrackingSettings(e) {
			void 0 !== e && (f(e), this.trackingSettings = e)
		}
		setMailSettings(e) {
			void 0 !== e && (l(e), this.mailSettings = e)
		}
		setHideWarnings(e) {
			if (void 0 !== e) {
		...
		toJSON() {
			const {
				...
				from: e,
				subject: n,
				personalizations: c(a)
			};
			return Array.isArray(u) && u.length > 0 && (w.attachments = c(u)), Array.isArray(g) && g.length > 0 && (w.categories = g.filter(e => "" !== e)), Array.isArray(s) && s.length > 0 && (w.content = c(s)), Object.keys(d).length > 0 && (w.headers = d), Object.keys(y).length > 0 && (w.mailSettings = y), Object.keys(b).length > 0 && (w.trackingSettings = b), Object.keys(m).length > 0 && (w.customArgs = m), Object.keys(h).length > 0 && (w.sections = h), Object.keys(p).length > 0 && (w.asm = p), void 0 !== t && (w.replyTo = t), void 0 !== r && (w.sendAt = r), void 0 !== f && (w.batchId = f), void 0 !== o && (w.templateId = o), void 0 !== l && (w.ipPoolName = l), i(w, ["substitutions", "dynamicTemplateData", "customArgs", "headers", "sections"])
		}
		static create(e) {
			return Array.isArray(e) ? e.filter(e => !!e).map(e => this.create(e)) : e instanceof p ? e : new p(e)
		}
	}
	e.exports = p
}, function (e, t, r) {
	...
	function u(e, t, r) {
		...
		return r.isMergeableObject(e) && a(e).forEach((function (t) {
			...
			})(e, s) || (c(e, s) && r.isMergeableObject(t[s]) ? n[s] = function (e, t) {
	...
	function l(e, t, r) {
		(r = r || {}).arrayMerge = r.arrayMerge || i, r.isMergeableObject = r.isMergeableObject || n, r.cloneUnlessOtherwiseSpecified = o;
		var s = Array.isArray(t);
		return s === Array.isArray(e) ? s ? r.arrayMerge(e, t, r) : u(e, t, r) : o(t, r)
	}
	l.all = function (e, t) {
	...
	"use strict";
	const n = (e, t, r, n) => {
		if (void 0 !== e && void 0 !== e[r] && typeof e[r] !== n) throw new Error(`${n} expected for \`${t}.${r}\``)
	};
	e.exports = {
		validateMailSettings(e) {
			...
			n(t, "bcc", "enable", "boolean"), n(t, "bcc", "email", "string"), n(r, "bypassListManagement", "enable", "boolean"), n(s, "footer", "enable", "boolean"), n(s, "footer", "text", "string"), n(s, "footer", "html", "string"), n(o, "sandboxMode", "enable", "boolean"), n(i, "spamCheck", "enable", "boolean"), n(i, "spamCheck", "threshold", "number"), n(i, "spamCheck", "postToUrl", "string")
		},
		validateTrackingSettings(e) {
			if ("object" != typeof e) throw new Error("Object expected for `trackingSettings`");
			const {
				clickTracking: t,
				openTracking: r,
				subscriptionTracking: s,
				ganalytics: o
			} = e;
			n(t, "clickTracking", "enable", "boolean"), n(t, "clickTracking", "enableText", "boolean"), n(r, "openTracking", "enable", "boolean"), n(r, "openTracking", "substitutionTag", "string"), n(s, "subscriptionTracking", "enable", "boolean"), n(s, "subscriptionTracking", "text", "string"), n(s, "subscriptionTracking", "html", "string"), n(s, "subscriptionTracking", "substitutionTag", "string"), n(o, "ganalytics", "enable", "boolean"), n(o, "ganalytics", "utm_source", "string"), n(o, "ganalytics", "utm_medium", "string"), n(o, "ganalytics", "utm_term", "string"), n(o, "ganalytics", "utm_content", "string"), n(o, "ganalytics", "utm_campaign", "string")
		}
	}
}, function (e, t, r) {
	"use strict";
	...
	class s extends Error {
		constructor(e) {
			...
			this.code = r, this.message = n, this.response = {
				headers: t,
				body: s
		...
		toString() {
			...
			return e && Array.isArray(e.errors) && e.errors.forEach(e => {
	...
	const n = r(77),
		...
		o = r(21).stdout,
		i = r(83),
		a = "win32" === process.platform && !(process.env.TERM || "").toLowerCase().startsWith("xterm"),
	...
	function f(e, t) {
		t = t || {};
		const r = o ? o.level : 0;
		e.level = void 0 === t.level ? r : t.level, e.enabled = "enabled" in t ? t.enabled : e.level > 0
	}
	...
	a && (s.blue.open = "[94m");
	for (const e of Object.keys(s)) s[e].closeRe = new RegExp(n(s[e].close), "g"), l[e] = {
		get() {
			const t = s[e];
	...
	for (const e of Object.keys(s.color.ansi)) u.has(e) || (l[e] = {
		get() {
			const t = this.level;
			return function () {
	...
	function d(e, t, r) {
		...
		}), n.hasGrey = this.hasGrey || "gray" === r || "grey" === r, n.__proto__ = h, n
	}
	...
	function m(e, t) {
		...
		const r = [].slice.call(arguments, 2),
			n = [t.raw[0]];
		for (let e = 1; e < t.length; e++) n.push(String(r[e - 1]).replace(/[{}\\]/g, "\\$&")), n.push(String(t.raw[e]));
		return i(e, n.join(""))
	}
	Object.defineProperties(p.prototype, l), e.exports = p(), e.exports.supportsColor = o, e.exports.default = e.exports
}, function (e, t, r) {
	"use strict";
	var n = /[|\\{}()[\]^$+*?.]/g;
	e.exports = function (e) {
	...
	(function (e) {
		...
		Object.defineProperty(e, "exports", {
			...
			get: function () {
				...
				const i = e => e,
					a = (e, t, r) => [e, t, r];
				r.color.close = "[39m", r.bgColor.close = "[49m", r.color.ansi = {
					ansi: n(i, 0)
				}, r.color.ansi256 = {
					ansi256: s(i, 0)
				}, r.color.ansi16m = {
				...
				for (let e of Object.keys(t)) {
					...
					const i = t[e];
					"ansi16" === e && (e = "ansi"), "ansi16" in i && (r.color.ansi[e] = n(i.ansi16, 0), r.bgColor.ansi[e] = n(i.ansi16, 10)), "ansi256" in i && (r.color.ansi256[e] = s(i.ansi256, 0), r.bgColor.ansi256[e] = s(i.ansi256, 10)), "rgb" in i && (r.color.ansi16m[e] = o(i.rgb, 0), r.bgColor.ansi16m[e] = o(i.rgb, 10))
				}
				return r
			}
		})
		...
		Object.keys(t).forEach((function (r) {
			...
			o[e][r] = function (e) {
				var t = function (t) {
					...
					var r = e(t);
					if ("object" == typeof r)
						for (var n = r.length, s = 0; s < n; s++) r[s] = Math.round(r[s]);
					return r
				};
	...
	function s(e) {
		var t = function () {
				for (var e = {}, t = Object.keys(n), r = t.length, s = 0; s < r; s++) e[t[s]] = {
					distance: -1,
					parent: null
				};
				return e
		...
		for (t[e].distance = 0; r.length;)
			for (var s = r.pop(), o = Object.keys(n[s]), i = o.length, a = 0; a < i; a++) {
				var c = o[a],
					u = t[c]; - 1 === u.distance && (u.distance = t[s].distance + 1, u.parent = s, r.unshift(c))
			}
		return t
	}
	...
	function i(e, t) {
		for (var r = [t[e].parent, e], s = n[t[e].parent][e], i = t[e].parent; t[i].parent;) r.unshift(t[i].parent), s = o(n[t[i].parent][i], s), i = t[i].parent;
		return s.conversion = r, s
	}
	e.exports = function (e) {
		for (var t = s(e), r = {}, n = Object.keys(t), o = n.length, a = 0; a < o; a++) {
			var c = n[a];
	...
	function u(e, t) {
		...
		for (const t of n)
			if (isNaN(t)) {
				if (!(s = t.match(o))) throw new Error(`Invalid Chalk template style argument: ${t} (in style '${e}')`);
	...
	e.exports = (e, t) => {
		const r = [],
			s = [];
		let o = [];
		if (t.replace(n, (t, n, i, a, u, p) => {
				if (n) o.push(c(n));
				else if (a) {
					const t = o.join("");
					o = [], s.push(0 === r.length ? t : f(e, r)(t)), r.push({
						inverse: i,
						styles: l(a)
					})
				} else if (u) {
	...
	e.exports = class {
		...
		setAggregatedBy(e) {
			if (void 0 !== e) {
				if ("string" != typeof e || !o.includes(e.toLowerCase())) throw new Error("Incorrect value for `aggregatedBy`");
				this.aggregatedBy = e
			}
		}
		getGlobal() {
		...
		getAdvanced(e) {
			...
			return void 0 === e || "string" == typeof e && i.includes(e.toLowerCase()) && (t.country = e), t
		}
		getAdvancedMailboxProviders(e) {
			const t = this.getGlobal();
			if (void 0 === e) return t;
			if (Array.isArray(e) && e.some(e => "string" != typeof e)) throw new Error("Array of strings expected for `mailboxProviders`");
			return t.mailBoxProviders = e, t
		}
		getAdvancedBrowsers(e) {
			const t = this.getGlobal();
			if (void 0 === e) return t;
			if (Array.isArray(e) && e.some(e => "string" != typeof e)) throw new Error("Array of strings expected for `browsers`");
			return t.browsers = e, t
		}
		getCategories(e) {
			if (void 0 === e) throw new Error("Array of strings expected for `categories`");
			if (!this._isValidArrayOfStrings(e)) throw new Error("Array of strings expected for `categories`");
			const t = this.getGlobal();
			return t.categories = e, t
		}
		getSubuser(e) {
			if (void 0 === e) throw new Error("Array of strings expected for `subusers`");
		...
		getSubuserSum(e = "delivered", t = a[0], r = 5, n = 0) {
			...
			if (!a.includes(t.toLowerCase())) throw new Error("desc or asc expected for `sortByDirection`");
			if ("number" != typeof r) throw new Error("number expected for `limit`");
			if ("number" != typeof n) throw new Error("number expected for `offset`");
			const s = this.getGlobal();
			return s.sortByMetric = e, s.sortByDirection = t, s.limit = r, s.offset = n, s
		}
		...
		_isValidArrayOfStrings(e) {
			return !!Array.isArray(e) && !(e.length < 1 || e.some(e => "string" != typeof e))
		}
	}
}, function (e, t, r) {
	"use strict";
	...
	e.exports = function (e, t) {
		...
		for (const e in t) t.hasOwnProperty(e) && (t[e] && Array.isArray(t[e]) ? r[e] = t[e] : t[e] && "object" == typeof t[e] ? r[e] = Object.assign({}, t[e]) : t[e] && (r[e] = t[e]));
		return r
	}
}]));
